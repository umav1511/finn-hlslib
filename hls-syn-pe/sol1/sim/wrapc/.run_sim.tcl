...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/uma/Desktop/Xilinx/Vivado/2020.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/uma/Desktop/Xilinx/Vivado/2020.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/uma/Desktop/Xilinx/Vivado/2020.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/uma/Desktop/Xilinx/Vivado/2020.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "testbench_pe.autotvin.dat"
	set constFileTvOut       "testbench_pe.autotvout.dat"
	set constFileHdlTvIn     "testbench_pe.autohdltvin.dat"
	set constFileHdlTvOut    "testbench_pe.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

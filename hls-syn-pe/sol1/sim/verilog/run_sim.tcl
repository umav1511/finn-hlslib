...
if {[file isfile testbench_pe.autotvin.dat]} {
	file delete -force testbench_pe.autotvin.dat
}

if {[file isfile testbench_pe.autotvout.dat]} {
	file delete -force testbench_pe.autotvout.dat
}

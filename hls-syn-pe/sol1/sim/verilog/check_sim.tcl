...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.testbench_pe.autotvin_in_V_V.dat"
         "c.testbench_pe.autotvin_out_V_V.dat"
         "c.testbench_pe.autotvin_weights_V_V.dat"
         "c.testbench_pe.autotvout_out_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.testbench_pe.autotvout_out_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

...
// ==============================================================
#ifndef __testbench_pe_mul_bkb__HH__
#define __testbench_pe_mul_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(testbench_pe_mul_bkb) {
    ...
    SC_CTOR(testbench_pe_mul_bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {

...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Testbench_add.autotvin_in1_V_V.dat"
         "c.Testbench_add.autotvin_in2_V_V.dat"
         "c.Testbench_add.autotvin_out_V_V.dat"
         "c.Testbench_add.autotvin_numReps.dat"
         "c.Testbench_add.autotvout_out_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Testbench_add.autotvout_out_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

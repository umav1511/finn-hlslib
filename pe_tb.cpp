...
void testbench_pe( stream<INPUT_STREAM_TYPE> &in, stream<OUTPUT_STREAM_TYPE> &out, stream<WEIGHT_STREAM_TYPE> & weights, int reps);

void sw_mult_mm(INPUT_STREAM_TYPE inp_value, WEIGHT_STREAM_TYPE wgt_value, OUTPUT_STREAM_TYPE   & out) {
        static int state = 0;
        static OUTPUT_STREAM_TYPE total = 0;
